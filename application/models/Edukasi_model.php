 <?php
    class Edukasi_model extends CI_Model
    {
        ...
        var $order_column = array(null, 'nama_materi', null, 'status', 'created_at', null);
        public function make_query_materi_edukasi()
        {
            // $id_materi_edukasi = $_POST['idpasien'];
            $this->db->select('
            master_materi_edukasi.id AS id_materi,
            master_materi_edukasi.nama_materi,
            master_materi_edukasi.nama_file,
            master_materi_edukasi.kategori,
            master_materi_edukasi.created_at,
            master_materi_edukasi.updated_at,
            referensi_kategori_materi.nama_kategori,
            ');
            $this->db->join('referensi_kategori_materi', 'referensi_kategori_materi.id = master_materi_edukasi.kategori', 'LEFT');
            $this->db->from('master_materi_edukasi');
            if (($_POST["search"]["value"])) {
                $this->db->like('nama_materi', $_POST["search"]["value"]);
            }

            if (isset($_POST["order"])) {
                $this->db->order_by($this->order_column[$_POST['order']['0']['column']], $_POST['order']['0']['dir']);
            } else {
                $this->db->order_by('master_materi_edukasi.id', 'ASC');
            }
        }


        public function make_datatables_materi_edukasi()
        {
            $this->make_query_materi_edukasi();
        ...
        public function get_filtered_data_materi_edukasi()
        {
            $this->make_query_materi_edukasi();
            $query = $this->db->get();
        ...
        public function get_all_data_materi_edukasi()
        {
            $this->db->select("*");
            $this->db->from('master_materi_edukasi');
        ...
        //end materi
        var $order_column1 = array(null, 'nama_materi', null, 'status', 'created_at', null);
        public function make_query_video_edukasi()
        {
            // $id_video_edukasi = $_POST['idpasien'];
            $this->db->select('
            master_video_edukasi.id AS id_video,
            master_video_edukasi.nama_video,
            master_video_edukasi.link_video,
            master_video_edukasi.created_at,
            master_video_edukasi.updated_at,
            ');
            $this->db->from('master_video_edukasi');
            if (($_POST["search"]["value"])) {
                $this->db->like('nama_video', $_POST["search"]["value"]);
            }

            if (isset($_POST["order"])) {
                $this->db->order_by($this->order_column1[$_POST['order']['0']['column']], $_POST['order']['0']['dir']);
            } else {
                $this->db->order_by('master_video_edukasi.id', 'ASC');
            }
        }


        public function make_datatables_video_edukasi()
        {
            $this->make_query_video_edukasi();
        ...
        public function get_filtered_data_video_edukasi()
        {
            $this->make_query_video_edukasi();
            $query = $this->db->get();
        ...
        public function get_all_data_video_edukasi()
        {
            $this->db->select("*");
            $this->db->from('master_video_edukasi');
            return $this->db->count_all_results();
