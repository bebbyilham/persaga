 <?php
    class Informasi_model extends CI_Model
    {
        ...
        var $order_column = array(null, 'nama_puskesmas', null, 'status', 'created_at', null);
        public function make_query_pelkes()
        {
            // $id_pelkes = $_POST['idpasien'];
            $this->db->select('*');
            // $this->db->where('jenis_layanan', 2);
            $this->db->from('master_pelayanan_kesehatan');
            if (($_POST["search"]["value"])) {
                $this->db->like('nama_puskesmas', $_POST["search"]["value"]);
            }
        ...
        public function make_datatables_pelkes()
        {
            $this->make_query_pelkes();
        ...
        public function get_filtered_data_pelkes()
        {
            $this->make_query_pelkes();
            $query = $this->db->get();
        ...
        public function get_all_data_pelkes()
        {
            $this->db->select("*");
            $this->db->from('master_pelayanan_kesehatan');
